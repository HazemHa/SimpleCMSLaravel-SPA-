...
<v-flex xs12 sm6 md4><v-text-field v-model="editedItem.post_id" label="post_id"></v-text-field></v-flex>
...
<v-flex xs12 sm6 md4><v-text-field v-model="editedItem.message" label="message"></v-text-field></v-flex>
...
<td class="text-xs-right">{{ props.item.post_id}} </td>
